...
- Support [decode & fliter of the HTML categories & attributes](https://pandao.github.io/editor.md/examples/html-categories-decode.html);
...
- 支持[识别和解析 HTML 标签，并且支持自定义过滤标签及属性解析](https://pandao.github.io/editor.md/examples/html-categories-decode.html)，具有可靠的安全性和几乎无限的扩展性；
